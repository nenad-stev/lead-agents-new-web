...
export const lesson10RichContent: RichLessonContent = {
  ...
  toc: [
    ...
    { id: "measurable-revenue", title: L("CRM pretvara aktivnosti u merljiv revenue sistem", "CRM turns activity into a measurable revenue system") },
  ...
  blocks: [
    ...
    {
      type: "section",
      id: "measurable-revenue",
      title: L("CRM pretvara aktivnosti u merljiv revenue sistem", "CRM turns activity into a measurable revenue system"),
      blocks: [
        {
          type: "paragraphs",
          paragraphs: P(
            [
              "CRM je mesto gde founder aktivnost prestaje da bude samo marketing signal i postaje merljiv revenue tok.",
              "Ako ne beležiš source, signal, kontekst i sledeći korak, nemaš sistem, imaš uspomene iz inbox-a.",
            ],
            [
              "CRM is the place where founder activity stops being just a marketing signal and becomes a measurable revenue stream.",
              "If you do not log source, signal, context, and next step, you do not have a system, you have memories from an inbox.",
            ],
          ),
        },
        {
          type: "table",
          caption: L("Obavezna CRM polja (minimum)", "Required CRM fields (minimum)"),
          headers: H(["Polje", "Purpose"], ["Field", "Purpose"]),
          rows: [
            { cells: [L("Lead source", "Lead source"), L("Kanal porekla", "Origin channel")] },
            { cells: [L("ICP segment", "ICP segment"), L("Fit segment", "Fit segment")] },
            { cells: [L("Company", "Company"), L("Account identitet", "Account identity")] },
            { cells: [L("Role", "Role"), L("Kupovna uloga", "Buying role")] },
            { cells: [L("Channel", "Channel"), L("Dodirni kanal", "Touchpoint channel")] },
            { cells: [L("Campaign", "Campaign"), L("Kampanja / asset", "Campaign / asset")] },
            { cells: [L("Message", "Message"), L("Poruka / ugao", "Message / angle")] },
            { cells: [L("Follow-up", "Follow-up"), L("Plan dodira", "Touch plan")] },
            { cells: [L("Response", "Response"), L("Odgovor status", "Response status")] },
            { cells: [L("Signal", "Signal"), L("Tip signala", "Signal type")] },
            { cells: [L("Intensity", "Intensity"), L("Jačina signala", "Signal strength")] },
            { cells: [L("Webinar status", "Webinar status"), L("Registered/attended/no-show", "Registered/attended/no-show")] },
            { cells: [L("Website activity", "Website activity"), L("Intent stranice i posete", "Intent pages and visits")] },
            { cells: [L("Next step", "Next step"), L("Sledeća akcija", "Next action")] },
            { cells: [L("Owner", "Owner"), L("Ko vodi lead", "Who owns the lead")] },
            { cells: [L("Lifecycle", "Lifecycle"), L("Lifecycle status", "Lifecycle status")] },
            { cells: [L("Meeting", "Meeting"), L("Status sastanka", "Meeting status")] },
            { cells: [L("Opportunity", "Opportunity"), L("Opportunity status", "Opportunity status")] },
            { cells: [L("Nurture", "Nurture"), L("Nurture status", "Nurture status")] },
            { cells: [L("Pipeline value", "Pipeline value"), L("Vrednost pipeline-a", "Pipeline value")] },
          ],
        },
        {
          type: "bullets",
          items: P(
            [
              "Koji kanal najviše pravi qualified prilike?",
              "Koji ICP segment ulazi u pipeline najbrže?",
              "Koja poruka i kampanja daju najbolji odgovor?",
              "Koji signal i intenzitet najčešće prelaze u meeting?",
              "Koji webinar status najviše konvertuje u opportunity?",
              "Gde leadovi zapinju u lifecycle-u i šta je sledeći korak?",
              "Koliko pipeline vrednosti i closed revenue-a dolazi iz FLG aktivnosti?",
            ],
            [
              "Which channel creates the most qualified opportunities?",
              "Which ICP segment enters pipeline fastest?",
              "Which message and campaign drive the best response?",
              "Which signal and intensity most often convert to meetings?",
              "Which webinar status converts most into opportunities?",
              "Where do leads stall in the lifecycle and what is the next step?",
              "How much pipeline value and closed revenue come from FLG activities?",
            ],
          ),
        },
        {
          ...
          variant: "accent",
          text: L(
            "Lifecycle primer: Cold lead → Engaged → Warm lead → Conversation → Qualified → Opportunity → Proposal → Closed won/lost.",
            "Lifecycle example: Cold lead → Engaged → Warm lead → Conversation → Qualified → Opportunity → Proposal → Closed won/lost.",
          ),
        },
      ],
    },
