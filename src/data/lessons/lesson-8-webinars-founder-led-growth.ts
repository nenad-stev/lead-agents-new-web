...
export const lesson8RichContent: RichLessonContent = {
  ...
  toc: [
    ...
    { id: "lead-magnet-system", title: L("Webinar kao high-intent lead magnet", "Webinar as a high-intent lead magnet") },
  ...
  blocks: [
    ...
    {
      type: "section",
      id: "lead-magnet-system",
      title: L("Webinar kao high-intent lead magnet u FLG sistemu", "Webinar as a high-intent lead magnet in the FLG system"),
      blocks: [
        {
          type: "paragraphs",
          paragraphs: P(
            [
              "U Founder-Led Growth sistemu webinar nije izolovan event. To je centralni conversion sloj između content-a i prodaje.",
              "Content zagreva temu i gradi kredibilitet. Outreach dovodi pravu publiku. Webinar pretvara pažnju u signal. CRM pretvara signal u sledeću akciju i pipeline.",
              "Kad su ove karike povezane, webinar radi kao high-intent lead magnet: ne skuplja samo registracije, već kvalifikovan kontekst za pravi follow-up.",
            ],
            [
              "In the Founder-Led Growth system, a webinar is not an isolated event. It is the core conversion layer between content and sales.",
              "Content warms the topic and builds credibility. Outreach brings the right audience. The webinar turns attention into signal. CRM turns the signal into next actions and pipeline.",
              "When these pieces are connected, the webinar works as a high-intent lead magnet: it does not just collect registrations, it collects qualified context for the right follow-up.",
            ],
          ),
        },
        {
          type: "pipeline-flow",
          title: L("Kako je webinar povezan sa ostatkom sistema", "How webinars connect to the rest of the system"),
          subtitle: L(
            "Jedan sistem: content i outreach hrane webinar, webinar hrani CRM i pipeline.",
            "One system: content and outreach feed webinars, webinars feed CRM and pipeline.",
          ),
          stages: [
            L("Content", "Content"),
            L("Outreach", "Outreach"),
      ...
      blocks: [
        {
          ...
          items: P(
            [
              "Definiši webinar temu iz ponovljenog ICP bola.",
              "Kreiraj landing stranicu sa jasnim outcome-om i CTA-om.",
              "Pripremi promo postove (minimum 5 objava).",
              "Pokreni outreach sekvencu ka relevantnim ICP kontaktima.",
              "Podesi reminder poruke pre live termina.",
              "Obezbedi snimanje i plan za replay distribuciju.",
              "Definiši jedan jasan webinar CTA (resurs, konsultacija ili sledeći korak).",
              "Pripremi follow-up segmente: no-show, attended, pitanja, CTA klikeri.",
              "Dodaj webinar signale i statuse u CRM.",
              "Dodeli owner-a i sledeći korak za high-intent leadove.",
              "Repurpose webinar u najmanje 5 content/outreach asset-a.",
            ],
            [
              "Define the webinar topic from repeated ICP pain.",
              "Create a landing page with a clear outcome and CTA.",
              "Prepare promotion posts (at least 5 posts).",
              "Run an outreach sequence to relevant ICP contacts.",
              "Set reminder messages before the live session.",
              "Ensure recording and a replay distribution plan.",
              "Define one clear webinar CTA (resource, consultation, or next step).",
              "Prepare follow-up segments: no-shows, attendees, question askers, CTA clickers.",
              "Add webinar signals and statuses to CRM.",
              "Assign an owner and next step for high-intent leads.",
              "Repurpose the webinar into at least 5 content/outreach assets.",
            ],
          ),
        },
      ],
