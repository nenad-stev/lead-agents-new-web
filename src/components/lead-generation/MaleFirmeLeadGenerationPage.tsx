...
const DELIVERABLE_GROUP_META: Array<{
  ...
  { label: { sr: "Fundamenti", en: "Foundation" }, icon: ClipboardList, slice: [0, 2] },
  { label: { sr: "Content", en: "Content" }, icon: MessageSquareText, slice: [2, 4] },
  { label: { sr: "Outreach", en: "Outreach" }, icon: Send, slice: [4, 7] },
  { label: { sr: "Kontrola", en: "Control" }, icon: BarChart3, slice: [7, 8] },
];
...
const OUTCOME_META: Array<{
  ...
  { icon: BadgeCheck, kicker: { sr: "Pozicioniranje", en: "Positioning" } },
  { icon: MessageSquareText, kicker: { sr: "Poverenje", en: "Trust" } },
  { icon: Radar, kicker: { sr: "Outreach", en: "Outreach" } },
  { icon: MessageCircle, kicker: { sr: "Pipeline", en: "Pipeline" } },
];

export function MaleFirmeLeadGenerationPage({ locale }: Props) {
    ...
    <>
      ...
      <main className="flg-preview flg-page">
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:px-8 md:py-20 lg:grid-cols-2 lg:items-center lg:gap-14">
            <div>
              <span className="flg-preview-badge">
                {locale === "sr" ? "1 do 30 zaposlenih" : "1 to 30 employees"}
              </span>
            ...
            <div className="flg-preview-hero__media">
              ...
              <div className="flg-preview-hero__media-card">
                ...
                <p className="mt-1 text-lg font-bold leading-snug text-foreground">
                  {locale === "sr"
                    ? "Ekspertiza foundera → pipeline"
                    : "Founder expertise → pipeline"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flg-fit__layout">
              <AnimateInView className="flg-fit__intro">
                ...
                <p className="flg-fit__lede">
                  {locale === "sr"
                    ? "Ako se prepoznajete — Founder Led Growth ima smisla."
                    : "If this sounds like you — Founder Led Growth fits."}
                </p>
              </AnimateInView>
            ...
            <AnimateInView>
              <header className="flg-gap__header">
                ...
                <h2 className="flg-gap__title">
                  {locale === "sr" ? (
                    <>
                      <span className="flg-gap__title-muted">Problem nije kvalitet. </span>
                      <span className="flg-gap__title-strong">Problem je predvidljiva prodaja.</span>
                    </>
                  ) : (
                    <>
                      <span className="flg-gap__title-muted">Not service quality. </span>
                      <span className="flg-gap__title-strong">Predictable sales.</span>
                    </>
                  )}
                </h2>
              </header>
        ...
        <section className="flg-outcome" aria-labelledby="results-heading">
          ...
          >
            <defs>
              <linearGradient id="flg-outcome-fill" x1="0" y1="0" x2="0.15" y2="1">
                <stop offset="0%" stopColor="#ffcc00" stopOpacity="0.045" />
                <stop offset="50%" stopColor="#ffcc00" stopOpacity="0.015" />
                <stop offset="100%" stopColor="#ffcc00" stopOpacity="0" />
              </linearGradient>
              <linearGradient id="flg-outcome-stroke" x1="0" y1="1" x2="1" y2="0">
        ...
        <section className="flg-compare">
          <div className="flg-compare__inner mx-auto max-w-6xl px-6 md:px-8">
            ...
            <AnimateInView delay={160} className="flg-compare__matrix">
              <div className="flg-compare__grid" role="table" aria-label={locale === "sr" ? "Poređenje rešenja" : "Solution comparison"}>
